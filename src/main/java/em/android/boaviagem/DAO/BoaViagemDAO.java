...
import em.android.boaviagem.Modelo.Gasto;
...
public class BoaViagemDAO {
    ...
    public List<Gasto> listarGasto(Viagem viagem){
    ...
    public double calcularGasto(Viagem viagem){
